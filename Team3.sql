  ...
  CREATE TABLE USERS 
   (	"FIRSTNAME" VARCHAR2(15 BYTE), 
	...
	"PASSWORD" VARCHAR2(20 BYTE), 
     ...
     CHECK (TITLE IN ('Student','Lecture','Warehouse manager'))
     );
...
INSERT INTO ITEMS(NAME, S_N, CATEGORY, AMOUNT, STATUS) VALUES ('BiDirectional SDI HDMI 12G', '9971855', 'Convertors', '1', 'IN');
 ...
 INSERT INTO USERS(FIRSTNAME,LASTNAME,EMAIL,BIRTHDAY,USERNAME,PASSWORD) VALUES ('Yovel','Efraim','yovelef@ac.sce.ac.il','12/01/1998','Yovel123','12345');
 INSERT INTO USERS(FIRSTNAME,LASTNAME,EMAIL,BIRTHDAY,USERNAME,PASSWORD) VALUES ('Efrat','Kadosh','efratka@ac.sce.ac.il','22/02/1998','Efrat123','12345');
 INSERT INTO USERS(FIRSTNAME,LASTNAME,EMAIL,BIRTHDAY,USERNAME,PASSWORD) VALUES ('yam','Biton','yambi@ac.sce.ac.il','12/05/1996','Yam123','12345');
 INSERT INTO USERS(FIRSTNAME,LASTNAME,EMAIL,BIRTHDAY,USERNAME,PASSWORD) VALUES ('Israel','lasri','israela@ac.sce.ac.il','06/04/1996','Israel123','12345');

INSERT INTO ORDERS(USERNAME,NAMEITEM,S_N,BORROW_DATE,RETURN_DATE) VALUES ('Efrat123','Sony A7III','4477024','12/05/2023','20/05/2023');
INSERT INTO ORDERS(USERNAME,NAMEITEM,S_N,BORROW_DATE,RETURN_DATE) VALUES ('Efrat123','Sony A7III','4476730','25/05/2023','30/05/2023');
INSERT INTO ORDERS(USERNAME,NAMEITEM,S_N,BORROW_DATE,RETURN_DATE) VALUES ('Yovel123','iPad Pro','Q97GTH4RXC','12/05/2023','20/05/2023');
INSERT INTO ORDERS(USERNAME,NAMEITEM,S_N,BORROW_DATE,RETURN_DATE) VALUES ('Israel123','Panasonic DC-S5','WJBA001375','12/05/2023','20/05/2023');
